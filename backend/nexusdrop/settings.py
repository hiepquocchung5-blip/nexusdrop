...
WSGI_APPLICATION = "nexusdrop.wsgi.application"
...
# Run tasks inline (no broker) when explicitly enabled — used for local dev
# without Redis/Celery. Defaults off so containerised behaviour is unchanged.
